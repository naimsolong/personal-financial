...
import Main from '@/Pages/Landing/Main.vue';
import Feature from '@/Pages/Landing/Feature.vue';
import Waitlist from '@/Pages/Landing/Waitlist.vue';
import Footer from '@/Pages/Landing/Footer.vue';
