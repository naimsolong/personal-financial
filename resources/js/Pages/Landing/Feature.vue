    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="max-w-screen-md mb-8 lg:mb-16">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Unleash Your Financial Potential.</h2>
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div>
                    ...
                    <p class="text-gray-500 dark:text-gray-400">We believe in transparency and community collaboration.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Easy Setup</h3>
                    <p class="text-gray-500 dark:text-gray-400">Set up your account in minutes, just simple steps to get you started.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Personalized Budgeting</h3>
                    <p class="text-gray-500 dark:text-gray-400">Tailor your dashboard to your preferences. Your financial journey, your way.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Smart Tracking Features</h3>
                    <p class="text-gray-500 dark:text-gray-400">Stay on top of your spending with real-time tracking and automated bill payments.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Advanced Strategies</h3>
                    <p class="text-gray-500 dark:text-gray-400">Level up your financial game with advanced strategies.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Mobiles App</h3>
